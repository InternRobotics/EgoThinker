...
LLM_VERSION="/mnt/petrelfs/peibaoqi/robot/VideoChat-Flash/llava-train_videochat/checkpoint/ego_stage2_qwen"
...
srun -p ${PARTITION} \
    ...
    --output_dir ./checkpoints/ego_stage3 \
    --num_train_epochs 1 \
    ...
    --verbose_logging True >> /mnt/petrelfs/peibaoqi/robot/VideoChat-Flash/llava-train_videochat/output_logs/stage3-video_sft/${MID_RUN_NAME}.log
