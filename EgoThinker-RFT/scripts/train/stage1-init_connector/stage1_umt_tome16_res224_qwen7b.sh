...
srun -p ${PARTITION} \
    ...
    --bf16 True \
    --output_dir /mnt/petrelfs/peibaoqi/robot/VideoChat-Flash/llava-train_videochat/checkpoint/s1 \
    --num_train_epochs 1 \
    ...
    --verbose_logging True >> /mnt/petrelfs/peibaoqi/robot/VideoChat-Flash/llava-train_videochat/output_logs/stage1-init_connector/${BASE_RUN_NAME}.log
